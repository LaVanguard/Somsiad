...
class DocumentPreprocessor:
    ...
    def preprocess(
        self, text: str, extract_substantive: bool = False
    ) -> Dict[str, str]:
        """
        ...
        """
        result = {"raw": text, "cleaned": self.clean_polish_legal_document(text)}
    ...
    def get_stats(self, before: str, after: str) -> Dict:
        ...
        return {
            ...
            "reduction_pct": (
                round((1 - len(after) / len(before)) * 100, 2) if len(before) > 0 else 0
            ),
